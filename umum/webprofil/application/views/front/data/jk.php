...
<body>
                ...
                <div id="container"></div>
                  <div class="blog-post">
                    ...
                    <figure class="highcharts-figure">
                      ...
                      Jumlah penduduk Desa Kuala Dua berdasarkan profil desa tahun 2019 berjumlah 29.436 jiwa yang terdiri dari 14.981 laki laki dan 14.455 perempuan. Sedangkan Jumlah penduduk berdasarkan usia adalah sebagai berikut :
  ...
  <script type="text/javascript">
    Highcharts.chart('container', {
      ...
      title: {
        text: 'Data Jumlah Penduduk Berdasarkan Usia'
      },
      yAxis: {
        allowDecimals: false,
        title: {
