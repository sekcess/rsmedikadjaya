<div class="container-fluid">
    ...
    <div class="dropdown">
        <a href="<?php echo base_url(); ?>user/index_map2" class="btn btn-primary">Edit</a>
        <a href="<?php echo base_url(); ?>user/leafletdrawinghasil2" class="btn btn-primary ml-1">Hasil GeoJSON</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h5 class="modal-title" id="newMapModalLabel"><b>PETA RAWAN BANJIR DESA KUALA DUA KECAMATAN SUNGAI RAYA KABUPATEN KUBU RAYA PROVINSI KALIMANTAN BARAT</b></h5>
                    <button type="button" class="fa fa-times" data-dismiss="modal" aria-label="Close"></button>
                </div>

                <form>
                    <div class="modal-body text-center">
                        <img style="height: 600px; width: 780px;" src="<?= base_url(); ?>assets/img/map/PetaRawanBanjirKualaDuaFIX.jpg">
                    </div>
                    <div class="modal-footer" style="float: left;">
                        <a class="btn btn-warning" href="<?= base_url('user/download2'); ?>">
                            <i class="fa fa-download" aria-hidden="true"></i>
                            <span class="ml-1">Download Map</span>
                        </a>
                    </div>
    ...
    <script>
        ...
        var jsonTest = new L.GeoJSON.AJAX(["<?= base_url(); ?>assets/geojson/RB1.geojson"], {
            onEachFeature: popUp,
            style: myStyle

        }).addTo(map);

        var jsonTest = new L.GeoJSON.AJAX(["<?= base_url(); ?>assets/geojson/RB2.geojson"], {
        ...
        function ajax_simpan() {
            var url = "<?php echo site_url('user/tambahleaflet2'); ?>";
