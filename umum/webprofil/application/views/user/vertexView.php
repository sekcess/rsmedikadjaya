<div class="container-fluid">
    ...
    <div class="dropdown">
        <a href="<?php echo base_url(); ?>user/index_map" class="btn btn-primary">Edit</a>
        <a href="<?php echo base_url(); ?>user/leafletdrawinghasil" class="btn btn-primary ml-1">Hasil GeoJSON</a>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="<?php echo base_url(); ?>user/rawanlongsor">Rawan Longsor</a>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h5 class="modal-title" id="newMapModalLabel"><b>PETA ADMINISTRASI DESA KUALA DUA KECAMATAN SUNGAI RAYA KABUPATEN KUBU RAYA PROVINSI KALIMANTAN BARAT</b></h5>
                    <button type="button" class="fa fa-times" data-dismiss="modal" aria-label="Close"></button>
                </div>

                <form>
                    <div class="modal-body text-center">
                        <img style="height: 600px; width: 780px;" src="<?= base_url(); ?>assets/img/map/PetaAdministrasiKualaDuaFIX.jpg">
                    </div>
                    <div class="modal-footer" style="float: left;">
                        <a class="btn btn-warning" href="<?= base_url('user/download1'); ?>">
                            <i class="fa fa-download" aria-hidden="true"></i>
                            <span class="ml-1">Download Map</span>
                        </a>
                    </div>
    ...
    <script>
        ...
        function popUp(f, l) {
            ...
            if (f.properties) {
                ...
                // }
                out.push("<b>Desa: </b>" + f.properties['NAMOBJ']);
                out.push("<b>Kecamatan: </b>" + f.properties['WADMKC']);
                out.push("<b>Kabupaten: </b>" + f.properties['WADMKK']);
        ...
        var jsonTest = new L.GeoJSON.AJAX(["<?= base_url(); ?>assets/geojson/DesaKualaDua.geojson"], {
            onEachFeature: popUp,
            style: myStyle
        ...
        var jsonTest = new L.GeoJSON.AJAX(["<?= base_url(); ?>assets/geojson/IrigasiKualaDua.geojson"], {
        ...
        function ajax_simpan() {
            var url = "<?php echo site_url('user/tambahleaflet'); ?>";
