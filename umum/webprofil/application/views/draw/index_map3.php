...
<body>
  ...
  <ul>
    <li><a href="<?php echo base_url('user/rawanlongsor'); ?>" class="btn btn-primary ml-1 mt-1">Home</a></li>
    <li><a href="<?php echo base_url('user/leafletdrawinghasil3'); ?>" class="btn btn-primary mt-1 ml-1">Hasil GeoJSON</a></li>

  </ul>
  <hr>
  <a href="<?php echo base_url('user/leafletdrawing3'); ?>" class="btn btn-success ml-1">Tambah Geojson</a>
  <hr>
  <table class="row ml-2" border="1" cellspacing="1" cellpadding="1" width="99%">
    ...
    <?php foreach ($tb_peta3 as $key) { ?>
      <tr>
        <td><?php echo $key->GeoJson ?></td>
        <td width="100px" align="center">
          <a href="leafletdrawingedit3?Id=<?php echo $key->Id; ?>" class="button">Edit</a>
          <a href="leafletdrawingDelete3?Id=<?php echo $key->Id; ?>" class="button">Delete</a>
        </td>
      </tr>
    <?php } ?>
  </table>
