...
<body>
  ...
  <ul>
    <li><a href="<?php echo base_url('user/vertex'); ?>" class="btn btn-primary ml-1 mt-1">Home</a></li>
    <li><a href="<?php echo base_url('user/leafletdrawinghasil'); ?>" class="btn btn-primary mt-1 ml-1">Hasil GeoJSON</a></li>

  </ul>
  <hr>
  <a href="<?php echo base_url('user/leafletdrawing'); ?>" class="btn btn-success ml-1">Tambah Geojson</a>
  <hr>
