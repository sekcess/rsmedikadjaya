...
<ul>
  <li><a href="<?php echo base_url('user/vertex'); ?>" class="btn btn-primary mt-1 ml-1">Home</a></li>
  <li><a href="<?php echo base_url(); ?>user/leafletdrawinghasil" class="btn btn-primary mt-1 ml-1">Hasil GeoJSON</a></li>
...
<button class="btn btn-success mt-2 ml-2" id="convert"> Simpan GeoJson </button>
<br>
...
<script>
  ...
  function ajax_simpan() {
    var url = "<?php echo site_url('user/editleaflet'); ?>";
    ...
    $.ajax({
      ...
      success: function(data) {
        $('#result').html('Data gambar berhasil diubah!');
      }
    });
  }
</script>
