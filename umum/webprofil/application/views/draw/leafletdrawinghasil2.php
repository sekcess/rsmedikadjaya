...
<head>
  ...
  <link rel="icon" type="png" href="<?= base_url(); ?>assets/img/icon/Lambang_Kabupaten_Kubu_Raya.png">
...
<body>
  <ul>
    <li><a href="<?php echo base_url('user/rawanbanjir'); ?>" class="btn btn-primary mt-1 ml-1">Home</a></li>
    <li><a href="<?php echo base_url(); ?>user/index_map2" class="btn btn-primary mt-1 ml-1">Edit</a></li>
  </ul>
  <div id="map"></div>
  ...
  <script>
    ...
    <?php foreach ($json as $key => $value) { ?>
      var drawnItems = L.geoJson(<?php echo $value->GeoJson; ?>)
        .addTo(map);
    <?php } ?>
  </script>
