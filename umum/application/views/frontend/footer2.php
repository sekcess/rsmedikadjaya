	...
	<script>
		$('#jenis').change(function() {
			...
			const drms = ['Foto KTP']
			const drgwl = ['Foto KTP']
			const drrip = ['Foto KTP']
			const drpt = ['Foto KTP']
			const drnar = ['Foto KTP']
			const drrm = ['Foto KTP']
			const drjnhs = ['Foto KTP']
			const drgs = ['Foto KTP']
			...
			if (jenisDokter == 'DRMS') {
				$('#syarat').html('')
				showList(drms)
			} else if (jenisDokter == 'DRGWL') {
				$('#syarat').html('')
				showList(drgwl)
			} else if (jenisDokter == 'DRRIP') {
				$('#syarat').html('')
				showList(drrip)
			} else if (jenisDokter == 'DRPT') {
				$('#syarat').html('')
				showList(drpt)
			} else if (jenisDokter == 'DRNAR') {
				$('#syarat').html('')
				showList(drnar)
			} else if (jenisDokter == 'DRRM') {
				$('#syarat').html('')
				showList(drrm)
			} else if (jenisDokter == 'DRJNHS') {
				$('#syarat').html('')
				showList(drjnhs)
			} else if (jenisDokter == 'DRGS') {
				$('#syarat').html('')
				showList(drgs)
