...
<!--   Core JS Files   -->
<script defer src="<?= base_url(); ?>assets/fontawesome-free-6.1.2/js/fontawesome.js"></script>
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'],
            datasets: [{
                label: 'Grafik Janji Temu Keluar',
                backgroundColor: 'rgb(255, 229, 25)',
                borderColor: 'rgb(255, 99, 132)',
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            labels: ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'],
            datasets: [{
                label: 'Grafik Keterangan Janji Temu',
                backgroundColor: 'rgb(255, 229, 25)',
                borderColor: 'rgb(255, 99, 132)',
