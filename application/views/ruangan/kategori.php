            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Kategori Ruangan</h4>
                        <div class="toolbar">
                            <!--        Here you can write extra buttons/actions for the toolbar              -->
                            <a href="<?= base_url() ?>ruanganAdmin/tambah_kategori">
                                    ...
                                    <?php foreach ($data as $key) : ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="<?= base_url() ?>ruanganAdmin/edit_kategori/<?= $key['id']; ?>" class="btn btn-simple btn-primary btn-icon"><i class="material-icons">edit</i></a>
                            ...
                            <div class="modal fade" id="hapusKategori<?= $key['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-small ">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" action="<?= base_url(); ?>ruanganAdmin/hapus_kategori/<?= $key['id']; ?>">
                                            <div class="modal-body text-center">
                                                <h5>Apakah anda yakin untuk menghapus data Kategori Ruangan ini? </h5>
                                            </div>
