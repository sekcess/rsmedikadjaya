            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Tambah Data Ruangan 24 Jam</h4>
                        ...
                        <div class="form-group form-info">
                            <label class="label-control">Nama Ruangan 24 Jam</label>
                            <input class="form-control" name="nama_ruangan" id="nama_ruangan" type="text" value="<?= set_value('nama_ruangan'); ?>" />
                        </div>
                        ...
                        <div class="input-group input-group-static mb-4">
                            <label for="kategori_ruangan24_id" class="ms-0">Pilih Kategori Ruangan 24 Jam</label>
                            <select class="form-control" id="kategori_ruangan24_id" name="kategori_ruangan24_id">
                        ...
                        <?= form_error('kategori_ruangan24_id', '<div class="text-danger">', '</div>'); ?>
