            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Tambah Karir</h4>
                        ...
                        <div class="form-group form-info">
                            ...
                            <input class="form-control" name="posisi" id="posisi" type="text" value="<?= set_value('posisi'); ?>" />
                        </div>
                        <?= form_error('posisi', '<div class="text-danger">', '</div>'); ?>
                        
                        <div class="form-group form-info">
                            <label class="label-control">Deadline</label>
                            <input class="form-control" name="deadline" id="deadline" type="date" value="<?= set_value('deadline'); ?>" />
                        </div>
